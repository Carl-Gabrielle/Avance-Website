  ...
  <div className="flex items-start gap-3">
    ...
    <span>
      ...
      <a
        ...
        className="mt-1 block text-sm font-medium text-[#444444] transition-colors hover:text-[#8aaa2c]"
      >
        0976-079-7391
      </a>
    </span>
            ...
            <div className="flex flex-col gap-5 sm:flex-row sm:items-center sm:justify-between">
              ...
              >
                ...
                <motion.button
                  ...
                  className="cursor-pointer group grid h-9 w-9 place-items-center rounded-full border border-black/[0.07] bg-white text-[#777777] transition-all duration-200 hover:border-[#111111] hover:bg-[#111111] hover:text-white"
                >
                  <ArrowUp
                    size={15}
                    strokeWidth={2}
